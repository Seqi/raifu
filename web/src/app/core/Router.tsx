			...
			<AuthContextProvider>
				<UserContextProvider>
					<Routes>
						...
						<Route path='app' element={ <WithAuthentication> <App /> </WithAuthentication> }>					
							<Route index={ true } element={ <Navigate to='armory' /> } />
							<Route path='armory' element={ <Suspense fallback={ <LoadingOverlay /> }><Armory/> </Suspense> } />
							<Route path='loadouts/*' element={ <Suspense fallback={ <LoadingOverlay /> }><LoadoutRouter/> </Suspense> } />
							<Route path='events/*' element={ <Suspense fallback={ <LoadingOverlay /> }><EventRouter/> </Suspense> } />
						</Route>
